...
def median_filter(x: torch.Tensor, filter_width: int):
    ...
    if x.is_cuda:
        ...
        except (RuntimeError, subprocess.CalledProcessError, TypeError, AttributeError):
            warnings.warn(
                "Failed to launch Triton kernels, likely due to Triton version incompatibility; "
